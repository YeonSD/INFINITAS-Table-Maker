...
## UI 소개
- 이미지 파일은 `docs/images/` 폴더에 추가해주세요.

### 서열표
![서열표 화면](docs/images/ui-rank.png)

### 소셜
![소셜 화면](docs/images/ui-social.png)

### 목표
![목표 화면](docs/images/ui-goals.png)

> 큰 이미지는 아래처럼 width를 지정해 표시할 수 있습니다.
> 
> `<img src="docs/images/ui-rank.png" alt="서열표 화면" width="960" />`
